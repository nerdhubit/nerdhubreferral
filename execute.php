...
if(isset($message['text']))
{
  ...
  {	  
	...
	$obj_desc = $testoLink;
	$short = make_bitly_url($url_affiliate,'nerdhub','json');
	$response = "$obj_desc\n$worldsym $short";
...
function make_bitly_url($url,$login,$format = 'xml',$version = '4')
{
	//create the URL
	$bitly = 'http://api.bit.ly/shorten?version='.$version.'&longUrl='.urlencode($url).'&login='.$login.'&apiKey=R_4320389688664cdd8db83dcecfb8c5ad'.'&format='.$format;
